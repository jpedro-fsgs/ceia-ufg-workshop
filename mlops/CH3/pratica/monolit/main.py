...
# Enabled only when PHOENIX_COLLECTOR_ENDPOINT is set (no-op otherwise)
# ---------------------------------------------------------------------------
...
# Uses embedded ChromaDB (PersistentClient) — no separate server required.
# ---------------------------------------------------------------------------
    ...
    async with _vs_lock:
        for file in files:
            ...
            try:
                ...
                if suffix in SUPPORTED_EXTENSIONS and OPENAI_API_KEY:
